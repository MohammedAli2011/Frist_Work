        ...
        <div class="container">
            ...
            <div class="icons-container d-flex align-items-center p-2">
                ...
                <div class="collapse search-collapse position-absolute top-100" id="search">
                    <form class="card card-body position-relative" role="search">
                        <input class="search-bar rounded pe-5" role="searchbox" type="search" name="search-bar" placeholder="search" id="">
                        <a class="search-bar-link position-absolute text-dark" type="submit" href="" title="search">
                             <i class="fa-solid fa-search"></i>
                        </a>
                    </form>
                </div>
...
document.getElementsByClassName("search-bar")[0].addEventListener("keyup", () => {
    document.getElementsByClassName("navbar")[0].style.background = "#fff !important";
});
...
if (window.location.href.includes("shop.html")) {
    let wPHeader = document.querySelector(".shop .header");
    let searchBar = document.querySelector(".shop .header .search form .search-bar");

    searchBar.addEventListener("focus", () => {
        searchBar.style.backgroundColor = "var(--bg-color)";
    });
